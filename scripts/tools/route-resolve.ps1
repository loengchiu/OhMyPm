...
$preferredSkill = $state.preferred_skill
$skill = if (HasText $ForceSkill) { $ForceSkill } else { Resolve-ExplicitSkill -IntentText $IntentText -PreferredSkill $preferredSkill }
